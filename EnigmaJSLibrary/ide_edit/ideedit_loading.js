...
this.event_4_7=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,4,7,this.event_4_7,this);

this.event_4_0=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,4,0,this.event_4_0,this);
this.myevent_draw=function() {if (this.image_single!=-1) { this.image_speed = 0; this.image_index = this.image_single; } 
if (this.visible && this.sprite_index != -1) enigma.global.draw_sprite_ext(this.sprite_index,this.image_index,this.x,this.y,this.image_xscale,this.image_yscale,this.image_angle,this.image_blend,this.image_alpha);};
...
this.event_2_3=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,2,3,this.event_2_3,this);

this.event_2_2=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,2,2,this.event_2_2,this);

this.event_2_1=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,2,1,this.event_2_1,this);

this.event_2_0=function(){/* Erroring code */};enigma.system.event_loop.link_event(this.id,2,0,this.event_2_0,this);
this.myevent_draw=function() {if (this.image_single!=-1) { this.image_speed = 0; this.image_index = this.image_single; } 
if (this.visible && this.sprite_index != -1) enigma.global.draw_sprite_ext(this.sprite_index,this.image_index,this.x,this.y,this.image_xscale,this.image_yscale,this.image_angle,this.image_blend,this.image_alpha);};
enigma.classes.depth(this, 0);};
